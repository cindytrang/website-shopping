veg_list = ['Artichokes', 'Asparagus', 'Beetroot', 'Peppers', 'Broccoli', 'Brussels Sprouts', 'Butternut Squash', 'Cabbage', 'Carrots', 'Cauliflower', 'Chard', 'Chilis', 'Cucumber', 'Garlic', 'Kale', 'Leek', 'Lettuce', 'Mushrooms', 'Onion', 'Peas', 'Potatoes', 'Pumpkin', 'Radish', 'Spinach', 'Sweetcorn', 'Tomatoes']
fruit_list = ['Apples', 'Apricots', 'Blackberries', 'Blueberries', 'Cherries', 'Grapefruit', 'Nectarines', 'Peaches', 'Pears', 'Plums', 'Pomegranates', 'Raspberries', 'Strawberries', 'Watermelon']


my_products = [['Artichokes', 'veg'],
['Asparagus', 'veg'],
['Beetroot', 'veg'],
['Peppers', 'veg'],
['Broccoli', 'veg'],
