...
function init() {
    ...
    // var heartIcons = document.querySelectorAll(".heartIconEmpty");
...
$(document).ready(function () {
  ...
  */
  function resetListeners(){
    ...
    var eIn;
    console.log("basket", basket, "fav", favourites);
...
function redraw() {
    ...
    console.log("checking favourites content" + favourites);
    if (basket !== null) {
    ...
    productDetails.forEach(function(product) {
        if (favourites.includes(product.name)) {
